...
static void CreatePDFDocument(UInt8 *data, CFIndex length)
{
...
static CGImageRef RenderPdfToImage(size_t pageNumber, int width, int height)
{
...
namespace Poppler {
    ...
    {
        CGContextRef ref = CreateBitmapContext(xres, yres);
